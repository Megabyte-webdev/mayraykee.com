...
function ChatList({selectedUser,setSelectedUser}) {
  ...
  return (
    <div className="sticky top-0 flex-1 h-max md:h-full w-full flex flex-col items-center gap-[3%] shadow-sm shadow-gray-300 py-[1%] bg-white">
       ...
       <ul className="min-h-20 w-full flex md:justify-start gap-2 min-[900px]:flex-col py-2 overflow-x-auto overflow-y-hidden md:overflow-y-auto">
          {getUsers()}
       </ul>
    </div>
  );
