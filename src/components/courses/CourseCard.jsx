...
function CourseCard({data}) {
    ...
    return ( 
    <li onClick={navigateToCoursePage} className="w-[220px] cursor-pointer hover:shadow-md hover:scale-105 duration-100 h-[220px] flex  flex-col rounded-[10px] p-[1%] gap-[10px] bg-white">
        ...
        <div className="flex flex-col text-small gap-[5px]  justify-between h-[40%] items-start px-[10px]">
            <h5 className="text-small font-semibold  text-blacktext-center truncate">{data?.title}</h5>
