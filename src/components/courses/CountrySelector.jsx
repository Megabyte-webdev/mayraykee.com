...
import GlobleLocator from '../../assets/pngs/globe-location.png'

function CountrySelector({ data, selected, setSelected}) {
    ...
    <div className="w-full flex">
      ...
      >
        <div className="relative mt-1 ">
          <div className="relative w-full flex items-center pl-[5px] cursor-default overflow-hidden rounded-lg bg-white text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-teal-300 sm:text-sm">
    <img src={GlobleLocator} className='h-[20px]'/>
            <Combobox.Input
              className="w-full outline-none border-none py-[6px] pl-3 pr-10 text-sm leading-5 font-semibold text-gray-400 focus:ring-0"
